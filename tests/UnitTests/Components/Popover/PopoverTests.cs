...
{
    [Fact]
    public void WitCloseButtonHeaderAndBody()
    {
        // Arrange
...
<div
  ...
  style=""z-index:9999;opacity:1;transition:opacity 300ms cubic-bezier(.54, 1.5, .38, 1.11);position:absolute;transform:translate3d(0px,0px,0);""
>
