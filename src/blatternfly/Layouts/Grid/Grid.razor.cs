...
public partial class Grid : ComponentBase
{
    ...
    /// <summary>The number of rows a column in the grid should span. Value should be a number 1-12.</summary>
    [Parameter] public int? Span { get; set; }

    /// <summary>the number of columns all grid items should span on a small device.</summary>
    [Parameter] public int? Small { get; set; }

    /// <summary>the number of columns all grid items should span on a medium device.</summary>
    [Parameter] public int? Medium { get; set; }

    /// <summary>the number of columns all grid items should span on a large device.</summary>
    [Parameter] public int? Large { get; set; }

    /// <summary>the number of columns all grid items should span on a xLarge device.</summary>
    [Parameter] public int? ExtraLarge { get; set; }

    /// <summary>the number of columns all grid items should span on a 2xLarge device.</summary>
