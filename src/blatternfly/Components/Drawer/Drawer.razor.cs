...
public partial class Drawer : ComponentBase
{
    ...
    /// <summary>Indicate if the drawer is expanded.</summary>
    [Parameter] public bool IsExpanded { get; set; }

    /// <summary>Indicates if the content element and panel element are displayed side by side.</summary>
    [Parameter] public bool IsInline { get; set; }

    /// <summary>Indicates if the drawer will always show both content and panel.</summary>
    [Parameter] public bool IsStatic { get; set; }

    /// <summary>Position of the drawer panel.</summary>
    [Parameter] public DrawerPosition Position { get; set; } = DrawerPosition.Right;

    /// <summary>Callback when drawer panel is expanded.</summary>
