...
public partial class NotificationDrawerGroup : ComponentBase
{
    ...
    /// <summary>Notification drawer group count.</summary>
    [Parameter] public int Count { get; set; }

    /// <summary>Adds styling to the group to indicate expanded state.</summary>
    [Parameter] public bool IsExpanded { get; set; }

    /// <summary>Adds styling to the group to indicate whether it has been read.</summary>
    [Parameter] public bool IsRead { get; set; }

    /// <summary>Callback for when group button is clicked to expand.</summary>
    [Parameter] public EventCallback<bool> OnExpand { get; set; }

    /// <summary>Notification drawer group title.</summary>
    ...
    /// <summary>Sets the heading level to use for the group title. Default is h1.</summary>
