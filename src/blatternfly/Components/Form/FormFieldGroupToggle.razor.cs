...
public partial class FormFieldGroupToggle : ComponentBase
{
    ...
    /// <summary>Flag indicating if the toggle is expanded.</summary>
    [Parameter] public bool IsExpanded { get; set; }

    /// <summary>Aria label of the toggle button.</summary>
    [Parameter] public string AriaLabel { get; set; }

    /// <summary>Sets the aria-labelledby attribute on the toggle button element.</summary>
    [Parameter] public string AriaLabelledBy { get; set; }

    /// <summary>The id applied to the toggle button.</summary>
    [Parameter] public string ToggleId { get; set; }

    /// <summary>Callback for onClick.</summary>
