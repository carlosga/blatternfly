...
public partial class FormFieldGroupHeader : ComponentBase
{
    ...
    /// <summary>The applied to the title div for accessibility.</summary>
    [Parameter] public string TitleTextId { get; set; }

    /// <summary>Field group header title description.</summary>
    [Parameter] public string TitleDescription { get; set; }

    /// <summary>Field group header actions.</summary>
