...
public partial class LoginMainFooter : ComponentBase
{
    ...
    /// <summary>Content rendered inside the login main footer as social media links.</summary>
    ...
    /// <summary>Content rendered inside of login main footer band do display a forgot credentials link.</summary>
