...
public partial class LoginForm : ComponentBase
{
    ...
    /// </summary>
    [Parameter]
    public ILoginFormModel Model { get; set; }
    ...
    /// </summary>
    [Parameter]
    public RenderFragment HelperTextIcon { get; set; }
    ...
    /// </summary>
    [Parameter]
    public EventCallback<string> OnChangeUsername { get; set; }

    /// <summary>
    /// Username validation state.
    /// </summary>
    [Parameter]
    public ValidatedOptions? UsernameValidation { get; set; }
    ...
    /// </summary>
    [Parameter]
    public EventCallback<string> OnChangePassword { get; set; }

    /// <summary>
    /// Password validation state.
    /// </summary>
    [Parameter]
    public ValidatedOptions? PasswordValidation { get; set; }

    /// <summary>
    /// Flag indicating if the user can toggle hiding the password.
    /// </summary>
    [Parameter]
    public bool IsShowPasswordEnabled { get; set; }

    /// <summary>
    /// Accessible label for the show password button.
    /// </summary>
    [Parameter]
    public string ShowPasswordAriaLabel { get; set; } = "Show password";

    /// <summary>
    /// Accessible label for the hide password button.
    /// </summary>
    [Parameter]
    public string HidePasswordAriaLabel { get; set; }  = "Hide password";

    /// <summary>
    /// Label for the log in button input.
    /// </summary>
    [Parameter]
    public string LoginButtonLabel { get; set; } = "Log In";
    ...
    /// </summary>
    [Parameter]
    public EventCallback<MouseEventArgs> OnLoginButtonClick { get; set; }
    ...
    /// </summary>
    [Parameter]
    public EventCallback<bool> OnChangeRememberMe { get; set; }

    /// <summary>
    /// Flag to indicate if the first item should not gain initial focus.
    /// </summary>
    [Parameter]
    public bool NoAutoFocus { get; set; } = false;
