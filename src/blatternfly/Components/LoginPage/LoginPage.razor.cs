...
public partial class LoginPage : ComponentBase
{
    ...
    /// </summary>
    [Parameter]
    public RenderFragment FooterListItems { get; set; }

    /// <summary>
    /// Adds list variant styles for the footer list component of the login page. The only current value is'inline'.
    /// </summary>
    [Parameter]
    public ListVariant FooterListVariants { get; set; } = ListVariant.Inline;
    ...
    /// </summary>
    [Parameter]
    public RenderFragment HeaderUtilities { get; set; }
    ...
    /// </summary>
    [Parameter]
    public string BackgroundImgFilterId { get; set;  }
