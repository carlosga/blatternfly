...
public partial class LoginMainHeader : ComponentBase
{
    ...
    /// <summary>Title for the login main header.</summary>
    [Parameter] public string Title { get; set; }

    /// <summary>Subtitle that contains the text, URL, and URL text for the login main header.</summary>
    [Parameter] public string Subtitle { get; set; }

    /// <summary>Actions that render for the login main header.</summary>
