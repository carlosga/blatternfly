...
public partial class DescriptionList : ComponentBase
{
    ...
    /// <summary>Sets the description list to auto fit.</summary>
    [Parameter] public bool IsAutoFit { get; set; }

    /// <summary>Sets the description list component term and description pair to a horizontal layout.</summary>
    [Parameter] public bool IsHorizontal { get; set; }

    /// <summary>Sets the description list to format automatically.</summary>
    [Parameter] public bool IsAutoColumnWidths { get; set; }

    /// <summary>Modifies the description list display to inline-grid.</summary>
    [Parameter] public bool IsInlineGrid { get; set; }

    /// <summary>Sets the description list to compact styling.</summary>
    [Parameter] public bool IsCompact { get; set; }

    /// <summary>Sets a horizontal description list to have fluid styling.</summary>
    [Parameter] public bool IsFluid { get; set; }

    /// <summary>Sets the the default placement of description list groups to fill from top to bottom.</summary>
    [Parameter] public bool IsFillColumns { get; set; }

    /// <summary>Sets the display size of the descriptions in the description list.</summary>
    [Parameter] public DescriptionListDisplaySize? DisplaySize { get; set; }

    /// <summary>Sets the number of columns on the description list at various breakpoints.</summary>
    [Parameter] public DescriptionListColumnModifiers ColumnModifier { get; set; }

    /// <summary>Indicates how the menu will align at various breakpoints.</summary>
    [Parameter] public OrientationModifiers Orientation { get; set; }

    /// <summary>Sets the minimum column size for the auto-fit (isAutoFit) layout at various breakpoints.</summary>
    [Parameter] public AutoFitModifiers AutoFitMinModifier { get; set; }

    /// <summary>Sets the description list's term column width.</summary>
    [Parameter] public string TermWidth { get; set; }

    /// <summary>Sets the horizontal description list's term column width at various breakpoints.</summary>
