...
public partial class PageNavigation : ComponentBase
{
    ...
    /// <summary>Modifier indicating if the PageNavigation is sticky to the top or bottom at various breakpoints.</summary>
    [Parameter] public StickyPositionModifiers StickyOnBreakpoint { get; set; }

    /// <summary>Flag indicating if the PageNavigation should have a shadow at the top.</summary>
    [Parameter] public bool HasShadowTop { get; set; }

    /// <summary>Flag indicating if the PageNavigation should have a shadow at the bottom.</summary>
    [Parameter] public bool HasShadowBottom { get; set; }

    /// <summary>Flag indicating if the PageNavigation has a scrolling overflow.</summary>
    [Parameter] public bool HasOverflowScroll { get; set; }

    private string CssClass => new CssBuilder("pf-c-page__main-nav")
