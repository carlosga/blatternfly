...
public partial class AboutModalContainer : ComponentBase
{
    ...
    /// <summary>id to use for About Modal Box aria labeled by.</summary>
    [Parameter] public string AboutModalBoxHeaderId { get; set; }

    /// <summary>id to use for About Modal Box aria described by</summary>
    [Parameter] public string AboutModalBoxContentId { get; set; }

    /// <summary>Set close button aria label</summary>
