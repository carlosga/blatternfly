...
public class DropdownItem : ComponentBase
{
    ...
    [CascadingParameter] private DropdownMenu ParentDropdownMenu { get; set; }
    ...
    /// <summary>Class applied to list element.</summary>
    [Parameter]
    public string ListItemCssClass { get; set; }

    /// <summary>Indicates which component will be used as dropdown item.</summary>
    [Parameter]
    public string Component { get; set; } = "a";

    /// <summary>Role for the item.</summary>
    [Parameter]
    public string Role { get; set; } = "menuitem";

    /// <summary>Render dropdown item as disabled option.</summary>
    [Parameter]
    public bool IsDisabled { get; set; }

    /// <summary>Render dropdown item as aria-disabled option.</summary>
    [Parameter]
    public bool IsAriaDisabled { get; set; }

    /// <summary>Render dropdown item as a non-interactive item.</summary>
    [Parameter]
    public bool IsPlainText { get; set; }

    /// <summary>Default hyperlink location.</summary>
    [Parameter]
    public string Href { get; set; } = string.Empty;

    /// <summary>tabIndex to use, null to unset it.</summary>
    [Parameter]
    public int? TabIndex { get; set; } = -1;

    /// <summary>Callback for click event.</summary>
    [Parameter]
    public EventCallback<MouseEventArgs> OnClick { get; set; }

    /// <summary>ID for the component element.</summary>
    [Parameter]
    public string ComponentId { get; set; }

    /// <summary>Flag indicating if hitting enter on an item also triggers an arrow down key press.</summary>
    [Parameter]
    public bool EnterTriggersArrowDown { get; set; }

    /// <summary>An image to display within the InternalDropdownItem, appearing before any component children.</summary>
    [Parameter]
    public RenderFragment Icon { get; set; }

    /// <summary>Initial focus on the item when the menu is opened (Note: Only applicable to one of the items).</summary>
    [Parameter]
    public bool AutoFocus { get; set; }

    /// <summary>A short description of the dropdown item, displayed under the dropdown item content.</summary>
    [Parameter]
