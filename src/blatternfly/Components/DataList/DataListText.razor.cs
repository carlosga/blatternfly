...
public partial class DataListText : ComponentBase
{
    ...
    /// <summary>Determines which element to render as a data list text. Usually div or span.</summary>
    ...
    /// <summary>Text to display on the tooltip.</summary>
    [Parameter] public string Tooltip { get; set; }

    /// <summary>Callback used to create the tooltip if text is truncated.</summary>
