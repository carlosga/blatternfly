...
/// <summary>HatCowboySideIcon icon.</summary>
public sealed class HatCowboySideIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "HatCowboySideIcon", height: 512, width: 640, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
