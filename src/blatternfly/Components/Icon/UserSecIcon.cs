...
/// <summary>UserSecIcon icon.</summary>
public sealed class UserSecIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "UserSecIcon", height: 1024, width: 830, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
