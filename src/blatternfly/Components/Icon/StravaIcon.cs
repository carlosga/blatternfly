...
/// <summary>StravaIcon icon.</summary>
public sealed class StravaIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "StravaIcon", height: 512, width: 384, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
