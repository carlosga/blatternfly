namespace Blatternfly.Components
{
    public sealed class StravaIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "StravaIcon", height: 512, width: 384, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public StravaIcon() : base(_definition) { }
    }
}