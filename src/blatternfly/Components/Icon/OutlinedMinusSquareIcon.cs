namespace Blatternfly.Components
{
    public sealed class OutlinedMinusSquareIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new(name: "OutlinedMinusSquareIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, yOffset: "", xOffset: "");
