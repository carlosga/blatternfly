namespace Blatternfly.Components
{
    public sealed class OutlinedMinusSquareIcon : BaseIcon
    {
        ...
        public static readonly IconDefinition IconDefinition = new(name: "OutlinedMinusSquareIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
