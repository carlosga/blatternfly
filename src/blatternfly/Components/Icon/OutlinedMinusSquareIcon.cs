namespace Blatternfly.Components
{
    public sealed class OutlinedMinusSquareIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "OutlinedMinusSquareIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public OutlinedMinusSquareIcon() : base(_definition) { }
    }
}