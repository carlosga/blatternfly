...
/// <summary>CloudSunRainIcon icon.</summary>
public sealed class CloudSunRainIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "CloudSunRainIcon", height: 512, width: 576, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
