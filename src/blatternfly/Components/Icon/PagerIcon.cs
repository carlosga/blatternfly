...
/// <summary>PagerIcon icon.</summary>
public sealed class PagerIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "PagerIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
