...
/// <summary>BandcampIcon icon.</summary>
public sealed class BandcampIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "BandcampIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
