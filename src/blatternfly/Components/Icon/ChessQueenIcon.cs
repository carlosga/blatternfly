...
/// <summary>ChessQueenIcon icon.</summary>
public sealed class ChessQueenIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "ChessQueenIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
