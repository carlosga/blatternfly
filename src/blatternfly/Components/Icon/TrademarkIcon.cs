...
/// <summary>TrademarkIcon icon.</summary>
public sealed class TrademarkIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "TrademarkIcon", height: 512, width: 640, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
