namespace Blatternfly.Components
{
    public sealed class SquareIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "SquareIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public SquareIcon() : base(_definition) { }
    }
}