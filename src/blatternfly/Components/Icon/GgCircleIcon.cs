namespace Blatternfly.Components
{
    public sealed class GgCircleIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "GgCircleIcon", height: 512, width: 512, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public GgCircleIcon() : base(_definition) { }
    }
}