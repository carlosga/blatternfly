...
/// <summary>GgCircleIcon icon.</summary>
public sealed class GgCircleIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "GgCircleIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
