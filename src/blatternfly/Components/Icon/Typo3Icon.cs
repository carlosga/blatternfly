...
/// <summary>Typo3Icon icon.</summary>
public sealed class Typo3Icon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "Typo3Icon", height: 512, width: 448, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
