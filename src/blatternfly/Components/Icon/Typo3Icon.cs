namespace Blatternfly.Components
{
    public sealed class Typo3Icon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "Typo3Icon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public Typo3Icon() : base(_definition) { }
    }
}