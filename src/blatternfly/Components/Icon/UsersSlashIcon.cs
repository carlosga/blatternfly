namespace Blatternfly.Components
{
    public sealed class UsersSlashIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "UsersSlashIcon", height: 512, width: 640, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public UsersSlashIcon() : base(_definition) { }
    }
}