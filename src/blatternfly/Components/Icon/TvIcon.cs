namespace Blatternfly.Components
{
    public sealed class TvIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "TvIcon", height: 512, width: 640, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public TvIcon() : base(_definition) { }
    }
}