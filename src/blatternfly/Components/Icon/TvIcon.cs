...
public sealed class TvIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "TvIcon", height: 512, width: 640, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
