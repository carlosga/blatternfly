...
/// <summary>BackwardIcon icon.</summary>
public sealed class BackwardIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "BackwardIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
