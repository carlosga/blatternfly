...
/// <summary>ParagraphIcon icon.</summary>
public sealed class ParagraphIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "ParagraphIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
