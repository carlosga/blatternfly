namespace Blatternfly.Components
{
    public sealed class ArrowCircleDownIcon : BaseIcon
    {
        ...
        public static readonly IconDefinition IconDefinition = new(name: "ArrowCircleDownIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
