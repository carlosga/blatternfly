namespace Blatternfly.Components
{
    public sealed class PalletIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "PalletIcon", height: 512, width: 640, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public PalletIcon() : base(_definition) { }
    }
}