...
/// <summary>CheeseIcon icon.</summary>
public sealed class CheeseIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "CheeseIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
