namespace Blatternfly.Components
{
    public sealed class StopCircleIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "StopCircleIcon", height: 512, width: 512, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public StopCircleIcon() : base(_definition) { }
    }
}