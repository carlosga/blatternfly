namespace Blatternfly.Components
{
    public sealed class PlayIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "PlayIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public PlayIcon() : base(_definition) { }
    }
}