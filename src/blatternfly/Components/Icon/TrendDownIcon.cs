...
/// <summary>TrendDownIcon icon.</summary>
public sealed class TrendDownIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "TrendDownIcon", height: 1024, width: 960, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
