...
/// <summary>MedkitIcon icon.</summary>
public sealed class MedkitIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "MedkitIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
