namespace Blatternfly.Components
{
    public sealed class MedkitIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "MedkitIcon", height: 512, width: 512, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public MedkitIcon() : base(_definition) { }
    }
}