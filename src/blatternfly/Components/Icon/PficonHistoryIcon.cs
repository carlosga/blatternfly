...
/// <summary>PficonHistoryIcon icon.</summary>
public sealed class PficonHistoryIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "PficonHistoryIcon", height: 1024, width: 1024, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
