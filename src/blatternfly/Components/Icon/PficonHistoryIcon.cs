namespace Blatternfly.Components
{
    public sealed class PficonHistoryIcon : BaseIcon
    {
        ...
        public static readonly IconDefinition IconDefinition = new(name: "PficonHistoryIcon", height: 1024, width: 1024, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
