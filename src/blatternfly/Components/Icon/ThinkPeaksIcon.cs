...
/// <summary>ThinkPeaksIcon icon.</summary>
public sealed class ThinkPeaksIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "ThinkPeaksIcon", height: 512, width: 576, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
