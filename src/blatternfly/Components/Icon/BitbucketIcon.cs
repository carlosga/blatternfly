...
/// <summary>BitbucketIcon icon.</summary>
public sealed class BitbucketIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "BitbucketIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
