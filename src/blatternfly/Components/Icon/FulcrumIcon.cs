...
/// <summary>FulcrumIcon icon.</summary>
public sealed class FulcrumIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "FulcrumIcon", height: 512, width: 320, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
