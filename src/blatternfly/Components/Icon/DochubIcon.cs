...
/// <summary>DochubIcon icon.</summary>
public sealed class DochubIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "DochubIcon", height: 512, width: 416, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
