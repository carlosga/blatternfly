namespace Blatternfly.Components
{
    public sealed class OutlinedFileIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "OutlinedFileIcon", height: 512, width: 384, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public OutlinedFileIcon() : base(_definition) { }
    }
}