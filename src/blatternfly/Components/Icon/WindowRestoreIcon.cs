...
/// <summary>WindowRestoreIcon icon.</summary>
public sealed class WindowRestoreIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "WindowRestoreIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
