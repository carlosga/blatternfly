namespace Blatternfly.Components
{
    public sealed class ChessRookIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "ChessRookIcon", height: 512, width: 384, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public ChessRookIcon() : base(_definition) { }
    }
}