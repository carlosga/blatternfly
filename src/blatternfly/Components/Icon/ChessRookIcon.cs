...
/// <summary>ChessRookIcon icon.</summary>
public sealed class ChessRookIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "ChessRookIcon", height: 512, width: 384, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
