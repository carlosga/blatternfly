...
/// <summary>SwatchbookIcon icon.</summary>
public sealed class SwatchbookIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "SwatchbookIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
