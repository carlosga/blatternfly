namespace Blatternfly.Components
{
    public sealed class PlugIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "PlugIcon", height: 512, width: 384, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public PlugIcon() : base(_definition) { }
    }
}