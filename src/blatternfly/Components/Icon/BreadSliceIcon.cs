...
/// <summary>BreadSliceIcon icon.</summary>
public sealed class BreadSliceIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "BreadSliceIcon", height: 512, width: 576, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
