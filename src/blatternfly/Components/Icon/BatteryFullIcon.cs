namespace Blatternfly.Components
{
    public sealed class BatteryFullIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "BatteryFullIcon", height: 512, width: 640, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public BatteryFullIcon() : base(_definition) { }
    }
}