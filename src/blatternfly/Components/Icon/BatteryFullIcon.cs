...
/// <summary>BatteryFullIcon icon.</summary>
public sealed class BatteryFullIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "BatteryFullIcon", height: 512, width: 640, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
