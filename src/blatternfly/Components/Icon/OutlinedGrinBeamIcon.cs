...
public sealed class OutlinedGrinBeamIcon : BaseIcon
{
    ...
    public static readonly IconDefinition IconDefinition = new(name: "OutlinedGrinBeamIcon", height: 512, width: 496, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
