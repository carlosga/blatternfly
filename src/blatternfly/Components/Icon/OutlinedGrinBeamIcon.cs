...
/// <summary>OutlinedGrinBeamIcon icon.</summary>
public sealed class OutlinedGrinBeamIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "OutlinedGrinBeamIcon", height: 512, width: 496, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
