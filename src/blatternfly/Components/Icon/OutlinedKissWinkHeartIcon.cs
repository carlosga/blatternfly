...
/// <summary>OutlinedKissWinkHeartIcon icon.</summary>
public sealed class OutlinedKissWinkHeartIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "OutlinedKissWinkHeartIcon", height: 512, width: 504, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
