namespace Blatternfly.Components
{
    public sealed class VolumeIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "VolumeIcon", height: 1024, width: 832, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public VolumeIcon() : base(_definition) { }
    }
}