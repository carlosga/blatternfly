...
/// <summary>VolumeIcon icon.</summary>
public sealed class VolumeIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "VolumeIcon", height: 1024, width: 832, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
