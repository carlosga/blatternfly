...
/// <summary>ShapesIcon icon.</summary>
public sealed class ShapesIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "ShapesIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
