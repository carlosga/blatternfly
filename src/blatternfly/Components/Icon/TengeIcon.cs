namespace Blatternfly.Components
{
    public sealed class TengeIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "TengeIcon", height: 512, width: 384, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public TengeIcon() : base(_definition) { }
    }
}