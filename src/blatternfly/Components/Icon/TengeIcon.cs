...
/// <summary>TengeIcon icon.</summary>
public sealed class TengeIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "TengeIcon", height: 512, width: 384, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
