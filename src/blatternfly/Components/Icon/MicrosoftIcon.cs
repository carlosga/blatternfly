...
/// <summary>MicrosoftIcon icon.</summary>
public sealed class MicrosoftIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "MicrosoftIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
