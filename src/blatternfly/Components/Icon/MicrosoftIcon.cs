namespace Blatternfly.Components
{
    public sealed class MicrosoftIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "MicrosoftIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public MicrosoftIcon() : base(_definition) { }
    }
}