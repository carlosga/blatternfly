...
/// <summary>RadiationAltIcon icon.</summary>
public sealed class RadiationAltIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "RadiationAltIcon", height: 512, width: 496, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
