namespace Blatternfly.Components
{
    public sealed class CaretSquareRightIcon : BaseIcon
    {
        ...
        public static readonly IconDefinition IconDefinition = new(name: "CaretSquareRightIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
