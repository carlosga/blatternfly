...
/// <summary>PatreonIcon icon.</summary>
public sealed class PatreonIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "PatreonIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
