...
/// <summary>ParkingIcon icon.</summary>
public sealed class ParkingIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "ParkingIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
