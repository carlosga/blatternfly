namespace Blatternfly.Components
{
    public sealed class OutlinedCloneIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "OutlinedCloneIcon", height: 512, width: 512, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public OutlinedCloneIcon() : base(_definition) { }
    }
}