namespace Blatternfly.Components
{
    public sealed class EllipsisVIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "EllipsisVIcon", height: 512, width: 192, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public EllipsisVIcon() : base(_definition) { }
    }
}