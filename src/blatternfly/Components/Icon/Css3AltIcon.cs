namespace Blatternfly.Components
{
    public sealed class Css3AltIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "Css3AltIcon", height: 512, width: 384, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public Css3AltIcon() : base(_definition) { }
    }
}