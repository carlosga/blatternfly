namespace Blatternfly.Components
{
    public sealed class MapMarkerIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "MapMarkerIcon", height: 512, width: 384, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public MapMarkerIcon() : base(_definition) { }
    }
}