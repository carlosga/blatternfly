...
/// <summary>QrcodeIcon icon.</summary>
public sealed class QrcodeIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "QrcodeIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
