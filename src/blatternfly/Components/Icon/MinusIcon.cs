namespace Blatternfly.Components
{
    public sealed class MinusIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "MinusIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public MinusIcon() : base(_definition) { }
    }
}