...
/// <summary>EnterpriseIcon icon.</summary>
public sealed class EnterpriseIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "EnterpriseIcon", height: 1024, width: 1024, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
