namespace Blatternfly.Components
{
    public sealed class TintSlashIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "TintSlashIcon", height: 512, width: 640, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public TintSlashIcon() : base(_definition) { }
    }
}