namespace Blatternfly.Components
{
    public sealed class VuejsIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "VuejsIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public VuejsIcon() : base(_definition) { }
    }
}