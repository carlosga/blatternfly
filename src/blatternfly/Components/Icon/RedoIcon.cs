namespace Blatternfly.Components
{
    public sealed class RedoIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "RedoIcon", height: 512, width: 512, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public RedoIcon() : base(_definition) { }
    }
}