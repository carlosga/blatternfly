...
public sealed class SignIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "SignIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
