namespace Blatternfly.Components
{
    public sealed class OutlinedGrinSquintIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "OutlinedGrinSquintIcon", height: 512, width: 496, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public OutlinedGrinSquintIcon() : base(_definition) { }
    }
}