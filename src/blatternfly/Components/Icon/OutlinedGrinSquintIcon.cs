namespace Blatternfly.Components
{
    public sealed class OutlinedGrinSquintIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new(name: "OutlinedGrinSquintIcon", height: 512, width: 496, svgPath: _svgPath, transform: null, yOffset: "", xOffset: "");
