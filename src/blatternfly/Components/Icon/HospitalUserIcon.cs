namespace Blatternfly.Components
{
    public sealed class HospitalUserIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "HospitalUserIcon", height: 512, width: 640, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public HospitalUserIcon() : base(_definition) { }
    }
}