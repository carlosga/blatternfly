...
/// <summary>HospitalUserIcon icon.</summary>
public sealed class HospitalUserIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "HospitalUserIcon", height: 512, width: 640, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
