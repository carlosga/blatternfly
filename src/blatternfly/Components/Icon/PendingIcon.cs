namespace Blatternfly.Components
{
    public sealed class PendingIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "PendingIcon", height: 1024, width: 1024, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public PendingIcon() : base(_definition) { }
    }
}