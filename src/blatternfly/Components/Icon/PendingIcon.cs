...
/// <summary>PendingIcon icon.</summary>
public sealed class PendingIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "PendingIcon", height: 1024, width: 1024, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
