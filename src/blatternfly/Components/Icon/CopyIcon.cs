...
public sealed class CopyIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "CopyIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
