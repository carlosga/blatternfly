namespace Blatternfly.Components
{
    public sealed class OffIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "OffIcon", height: 1024, width: 1024, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public OffIcon() : base(_definition) { }
    }
}