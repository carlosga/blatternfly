...
public sealed class OffIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "OffIcon", height: 1024, width: 1024, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
