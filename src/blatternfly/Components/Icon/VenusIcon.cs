namespace Blatternfly.Components
{
    public sealed class VenusIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "VenusIcon", height: 512, width: 288, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public VenusIcon() : base(_definition) { }
    }
}