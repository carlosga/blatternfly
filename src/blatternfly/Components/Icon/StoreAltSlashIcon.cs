...
/// <summary>StoreAltSlashIcon icon.</summary>
public sealed class StoreAltSlashIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "StoreAltSlashIcon", height: 512, width: 640, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
