namespace Blatternfly.Components
{
    public sealed class PrintAltIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "PrintAltIcon", height: 1024, width: 1024, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public PrintAltIcon() : base(_definition) { }
    }
}