...
/// <summary>TabletIcon icon.</summary>
public sealed class TabletIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "TabletIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
