namespace Blatternfly.Components
{
    public sealed class LongArrowAltDownIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "LongArrowAltDownIcon", height: 512, width: 256, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public LongArrowAltDownIcon() : base(_definition) { }
    }
}