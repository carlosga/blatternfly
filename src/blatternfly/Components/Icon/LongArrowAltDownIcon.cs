...
public sealed class LongArrowAltDownIcon : BaseIcon
{
    ...
    public static readonly IconDefinition IconDefinition = new(name: "LongArrowAltDownIcon", height: 512, width: 256, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
