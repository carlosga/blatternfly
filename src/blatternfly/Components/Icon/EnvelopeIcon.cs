...
/// <summary>EnvelopeIcon icon.</summary>
public sealed class EnvelopeIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "EnvelopeIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
