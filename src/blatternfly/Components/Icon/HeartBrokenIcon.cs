namespace Blatternfly.Components
{
    public sealed class HeartBrokenIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "HeartBrokenIcon", height: 512, width: 512, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public HeartBrokenIcon() : base(_definition) { }
    }
}