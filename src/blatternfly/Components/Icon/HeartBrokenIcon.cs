...
/// <summary>HeartBrokenIcon icon.</summary>
public sealed class HeartBrokenIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "HeartBrokenIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
