...
/// <summary>GooglePlayIcon icon.</summary>
public sealed class GooglePlayIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "GooglePlayIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
