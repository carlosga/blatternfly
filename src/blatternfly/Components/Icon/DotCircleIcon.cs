...
/// <summary>DotCircleIcon icon.</summary>
public sealed class DotCircleIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "DotCircleIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
