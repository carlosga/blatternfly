...
/// <summary>BookMedicalIcon icon.</summary>
public sealed class BookMedicalIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "BookMedicalIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
