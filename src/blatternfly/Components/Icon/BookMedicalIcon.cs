namespace Blatternfly.Components
{
    public sealed class BookMedicalIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "BookMedicalIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public BookMedicalIcon() : base(_definition) { }
    }
}