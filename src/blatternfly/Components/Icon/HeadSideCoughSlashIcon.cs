namespace Blatternfly.Components
{
    public sealed class HeadSideCoughSlashIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new(name: "HeadSideCoughSlashIcon", height: 512, width: 640, svgPath: _svgPath, transform: null, yOffset: "", xOffset: "");
