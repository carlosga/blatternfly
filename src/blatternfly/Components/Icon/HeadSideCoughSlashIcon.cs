namespace Blatternfly.Components
{
    public sealed class HeadSideCoughSlashIcon : BaseIcon
    {
        ...
        public static readonly IconDefinition IconDefinition = new(name: "HeadSideCoughSlashIcon", height: 512, width: 640, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
