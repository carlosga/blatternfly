namespace Blatternfly.Components
{
    public sealed class LockIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "LockIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public LockIcon() : base(_definition) { }
    }
}