...
public sealed class LockIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "LockIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
