...
public sealed class FaxIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "FaxIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
