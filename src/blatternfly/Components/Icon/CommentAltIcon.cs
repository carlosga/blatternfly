...
/// <summary>CommentAltIcon icon.</summary>
public sealed class CommentAltIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "CommentAltIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
