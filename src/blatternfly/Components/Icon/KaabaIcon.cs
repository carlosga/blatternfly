...
/// <summary>KaabaIcon icon.</summary>
public sealed class KaabaIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "KaabaIcon", height: 512, width: 576, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
