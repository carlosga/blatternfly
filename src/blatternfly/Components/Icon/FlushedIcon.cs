namespace Blatternfly.Components
{
    public sealed class FlushedIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "FlushedIcon", height: 512, width: 496, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public FlushedIcon() : base(_definition) { }
    }
}