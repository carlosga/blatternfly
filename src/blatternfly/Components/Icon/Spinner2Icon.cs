namespace Blatternfly.Components
{
    public sealed class Spinner2Icon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "Spinner2Icon", height: 1024, width: 1024, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public Spinner2Icon() : base(_definition) { }
    }
}