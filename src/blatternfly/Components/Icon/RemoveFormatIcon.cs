...
/// <summary>RemoveFormatIcon icon.</summary>
public sealed class RemoveFormatIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "RemoveFormatIcon", height: 512, width: 640, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
