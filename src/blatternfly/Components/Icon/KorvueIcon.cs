...
/// <summary>KorvueIcon icon.</summary>
public sealed class KorvueIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "KorvueIcon", height: 512, width: 446, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
