namespace Blatternfly.Components
{
    public sealed class KorvueIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "KorvueIcon", height: 512, width: 446, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public KorvueIcon() : base(_definition) { }
    }
}