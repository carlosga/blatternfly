...
/// <summary>OutlinedTiredIcon icon.</summary>
public sealed class OutlinedTiredIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "OutlinedTiredIcon", height: 512, width: 496, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
