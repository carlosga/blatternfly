namespace Blatternfly.Components
{
    public sealed class OutlinedTiredIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "OutlinedTiredIcon", height: 512, width: 496, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public OutlinedTiredIcon() : base(_definition) { }
    }
}