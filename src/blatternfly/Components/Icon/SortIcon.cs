namespace Blatternfly.Components
{
    public sealed class SortIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "SortIcon", height: 512, width: 320, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public SortIcon() : base(_definition) { }
    }
}