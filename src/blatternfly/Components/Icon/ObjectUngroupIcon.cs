namespace Blatternfly.Components
{
    public sealed class ObjectUngroupIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "ObjectUngroupIcon", height: 512, width: 576, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public ObjectUngroupIcon() : base(_definition) { }
    }
}