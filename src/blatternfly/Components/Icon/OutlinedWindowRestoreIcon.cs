namespace Blatternfly.Components
{
    public sealed class OutlinedWindowRestoreIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "OutlinedWindowRestoreIcon", height: 512, width: 512, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public OutlinedWindowRestoreIcon() : base(_definition) { }
    }
}