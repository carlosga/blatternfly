namespace Blatternfly.Components
{
    public sealed class OutlinedWindowRestoreIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new(name: "OutlinedWindowRestoreIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, yOffset: "", xOffset: "");
