...
/// <summary>OutlinedWindowRestoreIcon icon.</summary>
public sealed class OutlinedWindowRestoreIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "OutlinedWindowRestoreIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
