namespace Blatternfly.Components
{
    public sealed class SynagogueIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "SynagogueIcon", height: 512, width: 640, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public SynagogueIcon() : base(_definition) { }
    }
}