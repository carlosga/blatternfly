namespace Blatternfly.Components
{
    public sealed class DiceOneIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "DiceOneIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public DiceOneIcon() : base(_definition) { }
    }
}