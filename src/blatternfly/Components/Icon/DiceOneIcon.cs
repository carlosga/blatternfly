...
/// <summary>DiceOneIcon icon.</summary>
public sealed class DiceOneIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "DiceOneIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
