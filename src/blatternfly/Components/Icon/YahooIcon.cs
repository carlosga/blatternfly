...
/// <summary>YahooIcon icon.</summary>
public sealed class YahooIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "YahooIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
