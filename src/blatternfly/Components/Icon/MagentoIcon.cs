namespace Blatternfly.Components
{
    public sealed class MagentoIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "MagentoIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public MagentoIcon() : base(_definition) { }
    }
}