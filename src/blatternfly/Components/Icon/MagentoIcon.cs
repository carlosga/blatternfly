...
/// <summary>MagentoIcon icon.</summary>
public sealed class MagentoIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "MagentoIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
