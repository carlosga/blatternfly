...
public sealed class OutlinedBookmarkIcon : BaseIcon
{
    ...
    public static readonly IconDefinition IconDefinition = new(name: "OutlinedBookmarkIcon", height: 512, width: 384, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
