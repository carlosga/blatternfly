namespace Blatternfly.Components
{
    public sealed class OutlinedBookmarkIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "OutlinedBookmarkIcon", height: 512, width: 384, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public OutlinedBookmarkIcon() : base(_definition) { }
    }
}