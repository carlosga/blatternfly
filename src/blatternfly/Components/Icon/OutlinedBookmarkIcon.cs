...
/// <summary>OutlinedBookmarkIcon icon.</summary>
public sealed class OutlinedBookmarkIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "OutlinedBookmarkIcon", height: 512, width: 384, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
