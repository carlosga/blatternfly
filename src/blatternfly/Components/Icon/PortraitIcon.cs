...
/// <summary>PortraitIcon icon.</summary>
public sealed class PortraitIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "PortraitIcon", height: 512, width: 384, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
