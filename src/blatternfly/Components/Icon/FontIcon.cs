namespace Blatternfly.Components
{
    public sealed class FontIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "FontIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public FontIcon() : base(_definition) { }
    }
}