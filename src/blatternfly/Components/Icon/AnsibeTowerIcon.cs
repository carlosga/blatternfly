namespace Blatternfly.Components
{
    public sealed class AnsibeTowerIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "AnsibeTowerIcon", height: 390, width: 390, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public AnsibeTowerIcon() : base(_definition) { }
    }
}