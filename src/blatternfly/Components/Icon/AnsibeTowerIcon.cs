...
/// <summary>AnsibeTowerIcon icon.</summary>
public sealed class AnsibeTowerIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "AnsibeTowerIcon", height: 390, width: 390, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
