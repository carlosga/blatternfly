...
/// <summary>TeethIcon icon.</summary>
public sealed class TeethIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "TeethIcon", height: 512, width: 640, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
