namespace Blatternfly.Components
{
    public sealed class TeethIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "TeethIcon", height: 512, width: 640, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public TeethIcon() : base(_definition) { }
    }
}