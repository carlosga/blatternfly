namespace Blatternfly.Components
{
    public sealed class JiraIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "JiraIcon", height: 512, width: 496, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public JiraIcon() : base(_definition) { }
    }
}