...
/// <summary>RulerVerticalIcon icon.</summary>
public sealed class RulerVerticalIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "RulerVerticalIcon", height: 512, width: 256, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
