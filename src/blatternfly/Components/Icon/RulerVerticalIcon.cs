namespace Blatternfly.Components
{
    public sealed class RulerVerticalIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "RulerVerticalIcon", height: 512, width: 256, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public RulerVerticalIcon() : base(_definition) { }
    }
}