...
/// <summary>ToggleOnIcon icon.</summary>
public sealed class ToggleOnIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "ToggleOnIcon", height: 512, width: 576, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
