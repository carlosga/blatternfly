namespace Blatternfly.Components
{
    public sealed class YandexIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "YandexIcon", height: 512, width: 256, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public YandexIcon() : base(_definition) { }
    }
}