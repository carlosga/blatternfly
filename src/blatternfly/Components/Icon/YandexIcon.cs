...
/// <summary>YandexIcon icon.</summary>
public sealed class YandexIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "YandexIcon", height: 512, width: 256, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
