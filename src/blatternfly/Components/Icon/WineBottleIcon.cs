...
/// <summary>WineBottleIcon icon.</summary>
public sealed class WineBottleIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "WineBottleIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
