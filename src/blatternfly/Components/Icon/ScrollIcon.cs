...
/// <summary>ScrollIcon icon.</summary>
public sealed class ScrollIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "ScrollIcon", height: 512, width: 640, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
