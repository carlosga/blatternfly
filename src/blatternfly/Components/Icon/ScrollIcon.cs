namespace Blatternfly.Components
{
    public sealed class ScrollIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "ScrollIcon", height: 512, width: 640, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public ScrollIcon() : base(_definition) { }
    }
}