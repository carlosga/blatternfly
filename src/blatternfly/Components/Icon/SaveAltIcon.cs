...
/// <summary>SaveAltIcon icon.</summary>
public sealed class SaveAltIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "SaveAltIcon", height: 1024, width: 1024, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
