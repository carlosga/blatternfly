namespace Blatternfly.Components
{
    public sealed class OutlinedDotCircleIcon : BaseIcon
    {
        ...
        public static readonly IconDefinition IconDefinition = new(name: "OutlinedDotCircleIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
