namespace Blatternfly.Components
{
    public sealed class OutlinedDotCircleIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new(name: "OutlinedDotCircleIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, yOffset: "", xOffset: "");
