namespace Blatternfly.Components
{
    public sealed class MessagesIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "MessagesIcon", height: 1024, width: 952, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public MessagesIcon() : base(_definition) { }
    }
}