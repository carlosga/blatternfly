namespace Blatternfly.Components
{
    public sealed class ChevronCircleLeftIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new(name: "ChevronCircleLeftIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, yOffset: "", xOffset: "");
