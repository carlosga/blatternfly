namespace Blatternfly.Components
{
    public sealed class ChevronCircleLeftIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "ChevronCircleLeftIcon", height: 512, width: 512, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public ChevronCircleLeftIcon() : base(_definition) { }
    }
}