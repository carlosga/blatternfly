...
/// <summary>ChevronCircleLeftIcon icon.</summary>
public sealed class ChevronCircleLeftIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "ChevronCircleLeftIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
