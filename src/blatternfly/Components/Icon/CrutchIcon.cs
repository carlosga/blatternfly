...
/// <summary>CrutchIcon icon.</summary>
public sealed class CrutchIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "CrutchIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
