...
/// <summary>TicketAltIcon icon.</summary>
public sealed class TicketAltIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "TicketAltIcon", height: 512, width: 576, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
