...
/// <summary>UnlockIcon icon.</summary>
public sealed class UnlockIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "UnlockIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
