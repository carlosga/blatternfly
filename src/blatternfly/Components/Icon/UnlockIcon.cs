namespace Blatternfly.Components
{
    public sealed class UnlockIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "UnlockIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public UnlockIcon() : base(_definition) { }
    }
}