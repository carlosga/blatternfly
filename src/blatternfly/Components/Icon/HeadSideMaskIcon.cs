namespace Blatternfly.Components
{
    public sealed class HeadSideMaskIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "HeadSideMaskIcon", height: 512, width: 512, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public HeadSideMaskIcon() : base(_definition) { }
    }
}