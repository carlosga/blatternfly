...
public sealed class PlusIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "PlusIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
