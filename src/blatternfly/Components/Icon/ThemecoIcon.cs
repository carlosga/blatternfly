...
/// <summary>ThemecoIcon icon.</summary>
public sealed class ThemecoIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "ThemecoIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
