namespace Blatternfly.Components
{
    public sealed class DeviantartIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "DeviantartIcon", height: 512, width: 320, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public DeviantartIcon() : base(_definition) { }
    }
}