...
/// <summary>LocationArrowIcon icon.</summary>
public sealed class LocationArrowIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "LocationArrowIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
