...
/// <summary>LaptopHouseIcon icon.</summary>
public sealed class LaptopHouseIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "LaptopHouseIcon", height: 512, width: 640, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
