...
/// <summary>ToggleOffIcon icon.</summary>
public sealed class ToggleOffIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "ToggleOffIcon", height: 512, width: 576, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
