...
/// <summary>PficonTemplateIcon icon.</summary>
public sealed class PficonTemplateIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "PficonTemplateIcon", height: 1024, width: 1024, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
