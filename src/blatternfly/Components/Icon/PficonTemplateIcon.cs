...
public sealed class PficonTemplateIcon : BaseIcon
{
    ...
    public static readonly IconDefinition IconDefinition = new(name: "PficonTemplateIcon", height: 1024, width: 1024, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
