namespace Blatternfly.Components
{
    public sealed class CaretRightIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "CaretRightIcon", height: 512, width: 192, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public CaretRightIcon() : base(_definition) { }
    }
}