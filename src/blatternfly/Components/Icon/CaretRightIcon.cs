...
/// <summary>CaretRightIcon icon.</summary>
public sealed class CaretRightIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "CaretRightIcon", height: 512, width: 192, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
