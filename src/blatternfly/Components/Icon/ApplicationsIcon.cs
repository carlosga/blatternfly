...
/// <summary>ApplicationsIcon icon.</summary>
public sealed class ApplicationsIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "ApplicationsIcon", height: 1024, width: 1024, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
