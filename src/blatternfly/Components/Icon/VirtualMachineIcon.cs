...
/// <summary>VirtualMachineIcon icon.</summary>
public sealed class VirtualMachineIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "VirtualMachineIcon", height: 1024, width: 1152, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
