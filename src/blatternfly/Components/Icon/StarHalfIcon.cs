...
/// <summary>StarHalfIcon icon.</summary>
public sealed class StarHalfIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "StarHalfIcon", height: 512, width: 576, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
