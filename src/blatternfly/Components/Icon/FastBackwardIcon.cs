...
/// <summary>FastBackwardIcon icon.</summary>
public sealed class FastBackwardIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "FastBackwardIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
