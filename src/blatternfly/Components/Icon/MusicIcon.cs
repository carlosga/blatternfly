...
/// <summary>MusicIcon icon.</summary>
public sealed class MusicIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "MusicIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
