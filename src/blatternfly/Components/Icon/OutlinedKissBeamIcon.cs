namespace Blatternfly.Components
{
    public sealed class OutlinedKissBeamIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "OutlinedKissBeamIcon", height: 512, width: 496, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public OutlinedKissBeamIcon() : base(_definition) { }
    }
}