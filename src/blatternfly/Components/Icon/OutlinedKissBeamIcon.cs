...
public sealed class OutlinedKissBeamIcon : BaseIcon
{
    ...
    public static readonly IconDefinition IconDefinition = new(name: "OutlinedKissBeamIcon", height: 512, width: 496, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
