namespace Blatternfly.Components
{
    public sealed class LastfmSquareIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "LastfmSquareIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public LastfmSquareIcon() : base(_definition) { }
    }
}