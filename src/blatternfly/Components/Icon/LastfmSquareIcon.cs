...
/// <summary>LastfmSquareIcon icon.</summary>
public sealed class LastfmSquareIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "LastfmSquareIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
