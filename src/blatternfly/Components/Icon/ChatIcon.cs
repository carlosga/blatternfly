namespace Blatternfly.Components
{
    public sealed class ChatIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "ChatIcon", height: 1024, width: 1024, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public ChatIcon() : base(_definition) { }
    }
}