...
public sealed class ChatIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "ChatIcon", height: 1024, width: 1024, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
