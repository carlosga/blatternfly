...
/// <summary>PficonSortCommonDescIcon icon.</summary>
public sealed class PficonSortCommonDescIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "PficonSortCommonDescIcon", height: 1024, width: 1024, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
