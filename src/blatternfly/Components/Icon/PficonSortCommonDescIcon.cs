namespace Blatternfly.Components
{
    public sealed class PficonSortCommonDescIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new(name: "PficonSortCommonDescIcon", height: 1024, width: 1024, svgPath: _svgPath, transform: null, yOffset: "", xOffset: "");
