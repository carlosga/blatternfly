namespace Blatternfly.Components
{
    public sealed class BandAidIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "BandAidIcon", height: 512, width: 640, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public BandAidIcon() : base(_definition) { }
    }
}