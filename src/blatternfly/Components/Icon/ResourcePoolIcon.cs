...
/// <summary>ResourcePoolIcon icon.</summary>
public sealed class ResourcePoolIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "ResourcePoolIcon", height: 1024, width: 832, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
