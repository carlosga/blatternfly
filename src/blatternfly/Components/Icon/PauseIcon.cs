...
/// <summary>PauseIcon icon.</summary>
public sealed class PauseIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "PauseIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
