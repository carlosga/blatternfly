namespace Blatternfly.Components
{
    public sealed class PficonSortCommonAscIcon : BaseIcon
    {
        ...
        public static readonly IconDefinition IconDefinition = new(name: "PficonSortCommonAscIcon", height: 1024, width: 1024, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
