namespace Blatternfly.Components
{
    public sealed class PficonSortCommonAscIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new(name: "PficonSortCommonAscIcon", height: 1024, width: 1024, svgPath: _svgPath, transform: null, yOffset: "", xOffset: "");
