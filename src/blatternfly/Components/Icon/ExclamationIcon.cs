...
/// <summary>ExclamationIcon icon.</summary>
public sealed class ExclamationIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "ExclamationIcon", height: 512, width: 192, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
