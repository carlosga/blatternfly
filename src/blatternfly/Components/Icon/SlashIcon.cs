...
/// <summary>SlashIcon icon.</summary>
public sealed class SlashIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "SlashIcon", height: 512, width: 640, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
