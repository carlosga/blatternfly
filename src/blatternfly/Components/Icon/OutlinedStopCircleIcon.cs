...
/// <summary>OutlinedStopCircleIcon icon.</summary>
public sealed class OutlinedStopCircleIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "OutlinedStopCircleIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
