namespace Blatternfly.Components
{
    public sealed class TrailerIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "TrailerIcon", height: 512, width: 640, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public TrailerIcon() : base(_definition) { }
    }
}