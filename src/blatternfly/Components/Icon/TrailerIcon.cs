...
/// <summary>TrailerIcon icon.</summary>
public sealed class TrailerIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "TrailerIcon", height: 512, width: 640, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
