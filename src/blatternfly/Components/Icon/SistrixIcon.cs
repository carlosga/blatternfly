namespace Blatternfly.Components
{
    public sealed class SistrixIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "SistrixIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public SistrixIcon() : base(_definition) { }
    }
}