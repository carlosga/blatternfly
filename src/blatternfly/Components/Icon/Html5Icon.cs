namespace Blatternfly.Components
{
    public sealed class Html5Icon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "Html5Icon", height: 512, width: 384, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public Html5Icon() : base(_definition) { }
    }
}