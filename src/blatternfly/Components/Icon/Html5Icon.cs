...
/// <summary>Html5Icon icon.</summary>
public sealed class Html5Icon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "Html5Icon", height: 512, width: 384, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
