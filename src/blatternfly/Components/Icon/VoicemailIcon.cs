namespace Blatternfly.Components
{
    public sealed class VoicemailIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "VoicemailIcon", height: 512, width: 640, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public VoicemailIcon() : base(_definition) { }
    }
}