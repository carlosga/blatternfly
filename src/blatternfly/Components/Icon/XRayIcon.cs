...
public sealed class XRayIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "XRayIcon", height: 512, width: 640, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
