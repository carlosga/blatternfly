namespace Blatternfly.Components
{
    public sealed class XRayIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "XRayIcon", height: 512, width: 640, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public XRayIcon() : base(_definition) { }
    }
}