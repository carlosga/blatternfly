...
/// <summary>GrinStarsIcon icon.</summary>
public sealed class GrinStarsIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "GrinStarsIcon", height: 512, width: 496, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
