...
/// <summary>TwitchIcon icon.</summary>
public sealed class TwitchIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "TwitchIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
