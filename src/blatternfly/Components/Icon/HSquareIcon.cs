namespace Blatternfly.Components
{
    public sealed class HSquareIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "HSquareIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public HSquareIcon() : base(_definition) { }
    }
}