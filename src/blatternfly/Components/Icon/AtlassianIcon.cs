...
/// <summary>AtlassianIcon icon.</summary>
public sealed class AtlassianIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "AtlassianIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
