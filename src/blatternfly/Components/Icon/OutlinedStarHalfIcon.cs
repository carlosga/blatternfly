namespace Blatternfly.Components
{
    public sealed class OutlinedStarHalfIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "OutlinedStarHalfIcon", height: 512, width: 576, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public OutlinedStarHalfIcon() : base(_definition) { }
    }
}