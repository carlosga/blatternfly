...
/// <summary>OutlinedArrowAltCircleUpIcon icon.</summary>
public sealed class OutlinedArrowAltCircleUpIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "OutlinedArrowAltCircleUpIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
