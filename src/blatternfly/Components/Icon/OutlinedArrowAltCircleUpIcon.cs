namespace Blatternfly.Components
{
    public sealed class OutlinedArrowAltCircleUpIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new(name: "OutlinedArrowAltCircleUpIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, yOffset: "", xOffset: "");
