...
/// <summary>OrdersIcon icon.</summary>
public sealed class OrdersIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "OrdersIcon", height: 1024, width: 896, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
