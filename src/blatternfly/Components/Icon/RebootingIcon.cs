namespace Blatternfly.Components
{
    public sealed class RebootingIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "RebootingIcon", height: 1024, width: 1024, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public RebootingIcon() : base(_definition) { }
    }
}