...
/// <summary>RebootingIcon icon.</summary>
public sealed class RebootingIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "RebootingIcon", height: 1024, width: 1024, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
