...
public sealed class SoapIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "SoapIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
