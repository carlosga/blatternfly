...
/// <summary>ThumbTackIcon icon.</summary>
public sealed class ThumbTackIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "ThumbTackIcon", height: 1024, width: 640, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
