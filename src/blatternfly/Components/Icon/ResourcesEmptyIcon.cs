namespace Blatternfly.Components
{
    public sealed class ResourcesEmptyIcon : BaseIcon
    {
        ...
        public static readonly IconDefinition IconDefinition = new(name: "ResourcesEmptyIcon", height: 1024, width: 1024, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
