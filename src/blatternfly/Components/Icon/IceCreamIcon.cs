namespace Blatternfly.Components
{
    public sealed class IceCreamIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "IceCreamIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public IceCreamIcon() : base(_definition) { }
    }
}