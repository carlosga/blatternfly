...
/// <summary>FlickrIcon icon.</summary>
public sealed class FlickrIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "FlickrIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
