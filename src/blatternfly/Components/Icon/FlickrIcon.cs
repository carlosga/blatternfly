namespace Blatternfly.Components
{
    public sealed class FlickrIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "FlickrIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public FlickrIcon() : base(_definition) { }
    }
}