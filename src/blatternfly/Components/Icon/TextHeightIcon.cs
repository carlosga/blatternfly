namespace Blatternfly.Components
{
    public sealed class TextHeightIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "TextHeightIcon", height: 512, width: 576, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public TextHeightIcon() : base(_definition) { }
    }
}