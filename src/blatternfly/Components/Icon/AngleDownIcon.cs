namespace Blatternfly.Components
{
    public sealed class AngleDownIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "AngleDownIcon", height: 512, width: 320, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public AngleDownIcon() : base(_definition) { }
    }
}