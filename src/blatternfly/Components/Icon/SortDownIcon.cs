...
/// <summary>SortDownIcon icon.</summary>
public sealed class SortDownIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "SortDownIcon", height: 512, width: 320, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
