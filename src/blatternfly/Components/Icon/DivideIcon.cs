...
/// <summary>DivideIcon icon.</summary>
public sealed class DivideIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "DivideIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
