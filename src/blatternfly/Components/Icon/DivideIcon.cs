namespace Blatternfly.Components
{
    public sealed class DivideIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "DivideIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public DivideIcon() : base(_definition) { }
    }
}