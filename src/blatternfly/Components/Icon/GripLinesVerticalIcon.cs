namespace Blatternfly.Components
{
    public sealed class GripLinesVerticalIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new(name: "GripLinesVerticalIcon", height: 512, width: 256, svgPath: _svgPath, transform: null, yOffset: "", xOffset: "");
