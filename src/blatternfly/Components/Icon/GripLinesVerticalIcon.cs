...
/// <summary>GripLinesVerticalIcon icon.</summary>
public sealed class GripLinesVerticalIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "GripLinesVerticalIcon", height: 512, width: 256, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
