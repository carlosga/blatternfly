namespace Blatternfly.Components
{
    public sealed class CaretLeftIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "CaretLeftIcon", height: 512, width: 192, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public CaretLeftIcon() : base(_definition) { }
    }
}