...
/// <summary>GitterIcon icon.</summary>
public sealed class GitterIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "GitterIcon", height: 512, width: 384, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
