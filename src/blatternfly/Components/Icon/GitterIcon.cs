namespace Blatternfly.Components
{
    public sealed class GitterIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "GitterIcon", height: 512, width: 384, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public GitterIcon() : base(_definition) { }
    }
}