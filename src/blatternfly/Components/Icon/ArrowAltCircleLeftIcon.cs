...
/// <summary>ArrowAltCircleLeftIcon icon.</summary>
public sealed class ArrowAltCircleLeftIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "ArrowAltCircleLeftIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
