namespace Blatternfly.Components
{
    public sealed class ArrowAltCircleLeftIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "ArrowAltCircleLeftIcon", height: 512, width: 512, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public ArrowAltCircleLeftIcon() : base(_definition) { }
    }
}