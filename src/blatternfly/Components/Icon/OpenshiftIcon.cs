namespace Blatternfly.Components
{
    public sealed class OpenshiftIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "OpenshiftIcon", height: 100, width: 100, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public OpenshiftIcon() : base(_definition) { }
    }
}