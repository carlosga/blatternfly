...
/// <summary>BlenderPhoneIcon icon.</summary>
public sealed class BlenderPhoneIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "BlenderPhoneIcon", height: 512, width: 576, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
