namespace Blatternfly.Components
{
    public sealed class OnRunningIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "OnRunningIcon", height: 1024, width: 1024, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public OnRunningIcon() : base(_definition) { }
    }
}