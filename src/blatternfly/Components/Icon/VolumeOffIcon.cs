...
/// <summary>VolumeOffIcon icon.</summary>
public sealed class VolumeOffIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "VolumeOffIcon", height: 512, width: 256, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
