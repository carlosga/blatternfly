...
/// <summary>RecordVinylIcon icon.</summary>
public sealed class RecordVinylIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "RecordVinylIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
