...
public sealed class RulerHorizontalIcon : BaseIcon
{
    ...
    public static readonly IconDefinition IconDefinition = new(name: "RulerHorizontalIcon", height: 512, width: 576, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
