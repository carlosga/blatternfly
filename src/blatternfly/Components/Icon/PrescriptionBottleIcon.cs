namespace Blatternfly.Components
{
    public sealed class PrescriptionBottleIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "PrescriptionBottleIcon", height: 512, width: 384, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public PrescriptionBottleIcon() : base(_definition) { }
    }
}