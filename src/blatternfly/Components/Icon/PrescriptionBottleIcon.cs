...
/// <summary>PrescriptionBottleIcon icon.</summary>
public sealed class PrescriptionBottleIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "PrescriptionBottleIcon", height: 512, width: 384, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
