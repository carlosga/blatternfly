namespace Blatternfly.Components
{
    public sealed class PrescriptionBottleIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new(name: "PrescriptionBottleIcon", height: 512, width: 384, svgPath: _svgPath, transform: null, yOffset: "", xOffset: "");
