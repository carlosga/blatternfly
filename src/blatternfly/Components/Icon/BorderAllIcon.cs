namespace Blatternfly.Components
{
    public sealed class BorderAllIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "BorderAllIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public BorderAllIcon() : base(_definition) { }
    }
}