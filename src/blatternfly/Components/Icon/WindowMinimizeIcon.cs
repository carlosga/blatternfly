...
/// <summary>WindowMinimizeIcon icon.</summary>
public sealed class WindowMinimizeIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "WindowMinimizeIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
