namespace Blatternfly.Components
{
    public sealed class YCombinatorIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "YCombinatorIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public YCombinatorIcon() : base(_definition) { }
    }
}