...
/// <summary>YCombinatorIcon icon.</summary>
public sealed class YCombinatorIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "YCombinatorIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
