...
/// <summary>CloudMoonRainIcon icon.</summary>
public sealed class CloudMoonRainIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "CloudMoonRainIcon", height: 512, width: 576, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
