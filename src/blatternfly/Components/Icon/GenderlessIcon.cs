namespace Blatternfly.Components
{
    public sealed class GenderlessIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "GenderlessIcon", height: 512, width: 288, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public GenderlessIcon() : base(_definition) { }
    }
}