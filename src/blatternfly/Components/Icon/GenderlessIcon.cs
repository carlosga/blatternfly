...
/// <summary>GenderlessIcon icon.</summary>
public sealed class GenderlessIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "GenderlessIcon", height: 512, width: 288, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
