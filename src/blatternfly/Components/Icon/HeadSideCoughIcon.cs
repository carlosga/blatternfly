...
/// <summary>HeadSideCoughIcon icon.</summary>
public sealed class HeadSideCoughIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "HeadSideCoughIcon", height: 512, width: 640, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
