...
/// <summary>SeedlingIcon icon.</summary>
public sealed class SeedlingIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "SeedlingIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
