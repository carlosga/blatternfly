namespace Blatternfly.Components
{
    public sealed class PlayCircleIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "PlayCircleIcon", height: 512, width: 512, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public PlayCircleIcon() : base(_definition) { }
    }
}