...
/// <summary>ScreenIcon icon.</summary>
public sealed class ScreenIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "ScreenIcon", height: 1024, width: 1088, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
