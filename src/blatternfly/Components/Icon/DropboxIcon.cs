namespace Blatternfly.Components
{
    public sealed class DropboxIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "DropboxIcon", height: 512, width: 528, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public DropboxIcon() : base(_definition) { }
    }
}