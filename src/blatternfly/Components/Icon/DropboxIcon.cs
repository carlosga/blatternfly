...
/// <summary>DropboxIcon icon.</summary>
public sealed class DropboxIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "DropboxIcon", height: 512, width: 528, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
