namespace Blatternfly.Components
{
    public sealed class KeyIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "KeyIcon", height: 1024, width: 1024, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public KeyIcon() : base(_definition) { }
    }
}