...
public sealed class KeyIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "KeyIcon", height: 1024, width: 1024, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
