namespace Blatternfly.Components
{
    public sealed class MapMarkerAltIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "MapMarkerAltIcon", height: 512, width: 384, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public MapMarkerAltIcon() : base(_definition) { }
    }
}