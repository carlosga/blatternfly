...
/// <summary>MapMarkerAltIcon icon.</summary>
public sealed class MapMarkerAltIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "MapMarkerAltIcon", height: 512, width: 384, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
