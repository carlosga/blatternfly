...
/// <summary>AngleUpIcon icon.</summary>
public sealed class AngleUpIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "AngleUpIcon", height: 512, width: 320, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
