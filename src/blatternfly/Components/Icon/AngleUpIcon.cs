namespace Blatternfly.Components
{
    public sealed class AngleUpIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "AngleUpIcon", height: 512, width: 320, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public AngleUpIcon() : base(_definition) { }
    }
}