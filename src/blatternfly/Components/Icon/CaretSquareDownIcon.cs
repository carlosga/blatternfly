namespace Blatternfly.Components
{
    public sealed class CaretSquareDownIcon : BaseIcon
    {
        ...
        public static readonly IconDefinition IconDefinition = new(name: "CaretSquareDownIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
