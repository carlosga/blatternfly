namespace Blatternfly.Components
{
    public sealed class CaretSquareDownIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "CaretSquareDownIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public CaretSquareDownIcon() : base(_definition) { }
    }
}