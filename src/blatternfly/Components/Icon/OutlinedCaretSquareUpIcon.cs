namespace Blatternfly.Components
{
    public sealed class OutlinedCaretSquareUpIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new(name: "OutlinedCaretSquareUpIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, yOffset: "", xOffset: "");
