namespace Blatternfly.Components
{
    public sealed class ElementorIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "ElementorIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public ElementorIcon() : base(_definition) { }
    }
}