...
/// <summary>ElementorIcon icon.</summary>
public sealed class ElementorIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "ElementorIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
