namespace Blatternfly.Components
{
    public sealed class MobileIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "MobileIcon", height: 512, width: 320, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public MobileIcon() : base(_definition) { }
    }
}