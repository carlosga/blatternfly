...
/// <summary>MobileIcon icon.</summary>
public sealed class MobileIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "MobileIcon", height: 512, width: 320, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
