namespace Blatternfly.Components
{
    public sealed class HandHoldingMedicalIcon : BaseIcon
    {
        ...
        public static readonly IconDefinition IconDefinition = new(name: "HandHoldingMedicalIcon", height: 512, width: 576, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
