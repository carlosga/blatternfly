namespace Blatternfly.Components
{
    public sealed class HandHoldingMedicalIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new(name: "HandHoldingMedicalIcon", height: 512, width: 576, svgPath: _svgPath, transform: null, yOffset: "", xOffset: "");
