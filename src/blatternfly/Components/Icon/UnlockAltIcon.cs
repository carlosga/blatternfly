namespace Blatternfly.Components
{
    public sealed class UnlockAltIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "UnlockAltIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public UnlockAltIcon() : base(_definition) { }
    }
}