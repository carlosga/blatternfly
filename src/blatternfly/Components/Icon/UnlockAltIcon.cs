...
/// <summary>UnlockAltIcon icon.</summary>
public sealed class UnlockAltIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "UnlockAltIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
