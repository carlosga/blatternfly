namespace Blatternfly.Components
{
    public sealed class SdCardIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "SdCardIcon", height: 512, width: 384, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public SdCardIcon() : base(_definition) { }
    }
}