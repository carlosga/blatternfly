namespace Blatternfly.Components
{
    public sealed class ModxIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "ModxIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public ModxIcon() : base(_definition) { }
    }
}