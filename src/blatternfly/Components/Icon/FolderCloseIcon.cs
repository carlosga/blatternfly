namespace Blatternfly.Components
{
    public sealed class FolderCloseIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "FolderCloseIcon", height: 1024, width: 1088, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public FolderCloseIcon() : base(_definition) { }
    }
}