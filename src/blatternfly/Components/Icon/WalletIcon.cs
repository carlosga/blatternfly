...
/// <summary>WalletIcon icon.</summary>
public sealed class WalletIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "WalletIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
