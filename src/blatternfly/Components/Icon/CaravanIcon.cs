...
/// <summary>CaravanIcon icon.</summary>
public sealed class CaravanIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "CaravanIcon", height: 512, width: 640, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
