namespace Blatternfly.Components
{
    public sealed class CaravanIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "CaravanIcon", height: 512, width: 640, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public CaravanIcon() : base(_definition) { }
    }
}