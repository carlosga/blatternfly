...
/// <summary>ItalicIcon icon.</summary>
public sealed class ItalicIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "ItalicIcon", height: 512, width: 320, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
