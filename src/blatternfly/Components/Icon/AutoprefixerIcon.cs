namespace Blatternfly.Components
{
    public sealed class AutoprefixerIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "AutoprefixerIcon", height: 512, width: 640, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public AutoprefixerIcon() : base(_definition) { }
    }
}