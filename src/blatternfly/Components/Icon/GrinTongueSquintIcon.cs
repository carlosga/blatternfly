...
/// <summary>GrinTongueSquintIcon icon.</summary>
public sealed class GrinTongueSquintIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "GrinTongueSquintIcon", height: 512, width: 496, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
