namespace Blatternfly.Components
{
    public sealed class GrinTongueSquintIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "GrinTongueSquintIcon", height: 512, width: 496, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public GrinTongueSquintIcon() : base(_definition) { }
    }
}