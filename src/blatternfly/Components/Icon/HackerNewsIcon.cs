namespace Blatternfly.Components
{
    public sealed class HackerNewsIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "HackerNewsIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public HackerNewsIcon() : base(_definition) { }
    }
}