...
/// <summary>HackerNewsIcon icon.</summary>
public sealed class HackerNewsIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "HackerNewsIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
