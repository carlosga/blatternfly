...
/// <summary>LastfmIcon icon.</summary>
public sealed class LastfmIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "LastfmIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
