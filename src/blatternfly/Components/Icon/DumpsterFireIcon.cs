namespace Blatternfly.Components
{
    public sealed class DumpsterFireIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "DumpsterFireIcon", height: 512, width: 640, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public DumpsterFireIcon() : base(_definition) { }
    }
}