...
/// <summary>OtterIcon icon.</summary>
public sealed class OtterIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "OtterIcon", height: 512, width: 640, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
