...
public sealed class HandMiddleFingerIcon : BaseIcon
{
    ...
    public static readonly IconDefinition IconDefinition = new(name: "HandMiddleFingerIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
