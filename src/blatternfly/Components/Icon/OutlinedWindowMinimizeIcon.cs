namespace Blatternfly.Components
{
    public sealed class OutlinedWindowMinimizeIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new(name: "OutlinedWindowMinimizeIcon", height: 512, width: 512, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");
