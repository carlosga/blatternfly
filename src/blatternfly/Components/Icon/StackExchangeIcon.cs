namespace Blatternfly.Components
{
    public sealed class StackExchangeIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "StackExchangeIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public StackExchangeIcon() : base(_definition) { }
    }
}