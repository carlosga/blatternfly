...
/// <summary>StackExchangeIcon icon.</summary>
public sealed class StackExchangeIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "StackExchangeIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
