namespace Blatternfly.Components
{
    public sealed class PficonVcenterIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "PficonVcenterIcon", height: 1024, width: 1024, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public PficonVcenterIcon() : base(_definition) { }
    }
}