namespace Blatternfly.Components
{
    public sealed class PficonVcenterIcon : BaseIcon
    {
        ...
        public static readonly IconDefinition IconDefinition = new(name: "PficonVcenterIcon", height: 1024, width: 1024, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
