...
/// <summary>PficonVcenterIcon icon.</summary>
public sealed class PficonVcenterIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "PficonVcenterIcon", height: 1024, width: 1024, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
