namespace Blatternfly.Components
{
    public sealed class CaretDownIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "CaretDownIcon", height: 512, width: 320, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public CaretDownIcon() : base(_definition) { }
    }
}