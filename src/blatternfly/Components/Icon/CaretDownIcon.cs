...
/// <summary>CaretDownIcon icon.</summary>
public sealed class CaretDownIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "CaretDownIcon", height: 512, width: 320, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
