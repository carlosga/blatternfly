namespace Blatternfly.Components
{
    public sealed class FolderPlusIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "FolderPlusIcon", height: 512, width: 512, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public FolderPlusIcon() : base(_definition) { }
    }
}