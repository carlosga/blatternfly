...
/// <summary>ConciergeBellIcon icon.</summary>
public sealed class ConciergeBellIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "ConciergeBellIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
