namespace Blatternfly.Components
{
    public sealed class ConciergeBellIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "ConciergeBellIcon", height: 512, width: 512, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public ConciergeBellIcon() : base(_definition) { }
    }
}