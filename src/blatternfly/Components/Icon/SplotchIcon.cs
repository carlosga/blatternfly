...
/// <summary>SplotchIcon icon.</summary>
public sealed class SplotchIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "SplotchIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
