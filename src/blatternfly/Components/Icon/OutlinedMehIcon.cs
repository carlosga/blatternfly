...
/// <summary>OutlinedMehIcon icon.</summary>
public sealed class OutlinedMehIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "OutlinedMehIcon", height: 512, width: 496, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
