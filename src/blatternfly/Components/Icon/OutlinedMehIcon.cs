namespace Blatternfly.Components
{
    public sealed class OutlinedMehIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "OutlinedMehIcon", height: 512, width: 496, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public OutlinedMehIcon() : base(_definition) { }
    }
}