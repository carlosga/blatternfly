...
/// <summary>OutdentIcon icon.</summary>
public sealed class OutdentIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "OutdentIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
