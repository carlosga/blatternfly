namespace Blatternfly.Components
{
    public sealed class OutdentIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "OutdentIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public OutdentIcon() : base(_definition) { }
    }
}