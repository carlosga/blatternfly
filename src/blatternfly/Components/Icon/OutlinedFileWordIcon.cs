...
/// <summary>OutlinedFileWordIcon icon.</summary>
public sealed class OutlinedFileWordIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "OutlinedFileWordIcon", height: 512, width: 384, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
