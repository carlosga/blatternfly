namespace Blatternfly.Components
{
    public sealed class OutlinedFileWordIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "OutlinedFileWordIcon", height: 512, width: 384, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public OutlinedFileWordIcon() : base(_definition) { }
    }
}