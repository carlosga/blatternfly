namespace Blatternfly.Components
{
    public sealed class AllergiesIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "AllergiesIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public AllergiesIcon() : base(_definition) { }
    }
}