namespace Blatternfly.Components
{
    public sealed class SimCardIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "SimCardIcon", height: 512, width: 384, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public SimCardIcon() : base(_definition) { }
    }
}