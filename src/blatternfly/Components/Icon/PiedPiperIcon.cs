...
/// <summary>PiedPiperIcon icon.</summary>
public sealed class PiedPiperIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "PiedPiperIcon", height: 512, width: 480, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
