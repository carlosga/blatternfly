...
/// <summary>PausedIcon icon.</summary>
public sealed class PausedIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "PausedIcon", height: 1024, width: 1024, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
