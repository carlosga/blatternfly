namespace Blatternfly.Components
{
    public sealed class PausedIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "PausedIcon", height: 1024, width: 1024, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public PausedIcon() : base(_definition) { }
    }
}