...
/// <summary>MobileAltIcon icon.</summary>
public sealed class MobileAltIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "MobileAltIcon", height: 512, width: 320, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
