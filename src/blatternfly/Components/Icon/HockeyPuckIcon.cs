namespace Blatternfly.Components
{
    public sealed class HockeyPuckIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "HockeyPuckIcon", height: 512, width: 512, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public HockeyPuckIcon() : base(_definition) { }
    }
}