...
public sealed class GemIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "GemIcon", height: 512, width: 576, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
