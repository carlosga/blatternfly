...
/// <summary>SuitcaseIcon icon.</summary>
public sealed class SuitcaseIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "SuitcaseIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
