...
/// <summary>WonSignIcon icon.</summary>
public sealed class WonSignIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "WonSignIcon", height: 512, width: 576, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
