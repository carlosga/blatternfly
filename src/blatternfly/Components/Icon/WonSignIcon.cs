namespace Blatternfly.Components
{
    public sealed class WonSignIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "WonSignIcon", height: 512, width: 576, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public WonSignIcon() : base(_definition) { }
    }
}