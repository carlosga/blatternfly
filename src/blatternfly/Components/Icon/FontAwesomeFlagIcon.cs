...
/// <summary>FontAwesomeFlagIcon icon.</summary>
public sealed class FontAwesomeFlagIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "FontAwesomeFlagIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
