namespace Blatternfly.Components
{
    public sealed class FontAwesomeFlagIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "FontAwesomeFlagIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public FontAwesomeFlagIcon() : base(_definition) { }
    }
}