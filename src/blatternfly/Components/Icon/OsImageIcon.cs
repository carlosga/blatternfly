namespace Blatternfly.Components
{
    public sealed class OsImageIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "OsImageIcon", height: 1024, width: 1024, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public OsImageIcon() : base(_definition) { }
    }
}