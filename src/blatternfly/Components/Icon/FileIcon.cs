namespace Blatternfly.Components
{
    public sealed class FileIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "FileIcon", height: 512, width: 384, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public FileIcon() : base(_definition) { }
    }
}