namespace Blatternfly.Components
{
    public sealed class UserIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "UserIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public UserIcon() : base(_definition) { }
    }
}