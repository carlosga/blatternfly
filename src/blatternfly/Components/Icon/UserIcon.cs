...
public sealed class UserIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "UserIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
