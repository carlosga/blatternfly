namespace Blatternfly.Components
{
    public sealed class ServicestackIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "ServicestackIcon", height: 512, width: 496, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public ServicestackIcon() : base(_definition) { }
    }
}