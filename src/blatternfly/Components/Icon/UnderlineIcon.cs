...
/// <summary>UnderlineIcon icon.</summary>
public sealed class UnderlineIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "UnderlineIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
