namespace Blatternfly.Components
{
    public sealed class UnderlineIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "UnderlineIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public UnderlineIcon() : base(_definition) { }
    }
}