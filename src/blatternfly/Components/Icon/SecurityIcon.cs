...
/// <summary>SecurityIcon icon.</summary>
public sealed class SecurityIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "SecurityIcon", height: 1024, width: 896, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
