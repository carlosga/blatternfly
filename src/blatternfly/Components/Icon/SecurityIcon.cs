namespace Blatternfly.Components
{
    public sealed class SecurityIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "SecurityIcon", height: 1024, width: 896, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public SecurityIcon() : base(_definition) { }
    }
}