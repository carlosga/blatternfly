...
public sealed class NpmIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "NpmIcon", height: 512, width: 576, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
