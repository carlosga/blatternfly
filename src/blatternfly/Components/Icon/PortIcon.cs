...
public sealed class PortIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "PortIcon", height: 1024, width: 960, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
