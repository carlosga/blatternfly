...
/// <summary>StepBackwardIcon icon.</summary>
public sealed class StepBackwardIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "StepBackwardIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
