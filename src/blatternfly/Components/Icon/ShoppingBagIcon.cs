namespace Blatternfly.Components
{
    public sealed class ShoppingBagIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "ShoppingBagIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public ShoppingBagIcon() : base(_definition) { }
    }
}