...
/// <summary>ShoppingBagIcon icon.</summary>
public sealed class ShoppingBagIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "ShoppingBagIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
