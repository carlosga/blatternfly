namespace Blatternfly.Components
{
    public sealed class BatteryEmptyIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "BatteryEmptyIcon", height: 512, width: 640, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public BatteryEmptyIcon() : base(_definition) { }
    }
}