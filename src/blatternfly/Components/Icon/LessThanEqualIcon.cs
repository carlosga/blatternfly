...
/// <summary>LessThanEqualIcon icon.</summary>
public sealed class LessThanEqualIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "LessThanEqualIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
