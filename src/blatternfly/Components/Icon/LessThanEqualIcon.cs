namespace Blatternfly.Components
{
    public sealed class LessThanEqualIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "LessThanEqualIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public LessThanEqualIcon() : base(_definition) { }
    }
}