...
/// <summary>OutlinedGrinAltIcon icon.</summary>
public sealed class OutlinedGrinAltIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "OutlinedGrinAltIcon", height: 512, width: 496, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
