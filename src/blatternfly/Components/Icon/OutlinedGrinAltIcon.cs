namespace Blatternfly.Components
{
    public sealed class OutlinedGrinAltIcon : BaseIcon
    {
        ...
        public static readonly IconDefinition IconDefinition = new(name: "OutlinedGrinAltIcon", height: 512, width: 496, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
