...
/// <summary>CatalogIcon icon.</summary>
public sealed class CatalogIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "CatalogIcon", height: 1024, width: 1088, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
