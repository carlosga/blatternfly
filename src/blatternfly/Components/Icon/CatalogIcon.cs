namespace Blatternfly.Components
{
    public sealed class CatalogIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "CatalogIcon", height: 1024, width: 1088, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public CatalogIcon() : base(_definition) { }
    }
}