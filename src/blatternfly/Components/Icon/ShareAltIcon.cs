namespace Blatternfly.Components
{
    public sealed class ShareAltIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "ShareAltIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public ShareAltIcon() : base(_definition) { }
    }
}