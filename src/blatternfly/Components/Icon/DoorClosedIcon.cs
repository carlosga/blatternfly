...
/// <summary>DoorClosedIcon icon.</summary>
public sealed class DoorClosedIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "DoorClosedIcon", height: 512, width: 640, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
