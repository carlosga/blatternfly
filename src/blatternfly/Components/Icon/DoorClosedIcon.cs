namespace Blatternfly.Components
{
    public sealed class DoorClosedIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "DoorClosedIcon", height: 512, width: 640, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public DoorClosedIcon() : base(_definition) { }
    }
}