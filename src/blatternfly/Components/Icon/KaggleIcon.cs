namespace Blatternfly.Components
{
    public sealed class KaggleIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "KaggleIcon", height: 512, width: 320, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public KaggleIcon() : base(_definition) { }
    }
}