...
/// <summary>ArrowLeftIcon icon.</summary>
public sealed class ArrowLeftIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "ArrowLeftIcon", height: 512, width: 448, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
