namespace Blatternfly.Components
{
    public sealed class ArrowLeftIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "ArrowLeftIcon", height: 512, width: 448, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public ArrowLeftIcon() : base(_definition) { }
    }
}