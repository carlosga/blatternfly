namespace Blatternfly.Components
{
    public sealed class DoorOpenIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "DoorOpenIcon", height: 512, width: 640, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public DoorOpenIcon() : base(_definition) { }
    }
}