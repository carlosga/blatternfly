...
/// <summary>CrossIcon icon.</summary>
public sealed class CrossIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "CrossIcon", height: 512, width: 384, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
