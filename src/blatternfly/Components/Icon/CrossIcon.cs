namespace Blatternfly.Components
{
    public sealed class CrossIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "CrossIcon", height: 512, width: 384, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public CrossIcon() : base(_definition) { }
    }
}