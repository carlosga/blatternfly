...
/// <summary>PauseCircleIcon icon.</summary>
public sealed class PauseCircleIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "PauseCircleIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
