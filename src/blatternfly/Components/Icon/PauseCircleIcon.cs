namespace Blatternfly.Components
{
    public sealed class PauseCircleIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "PauseCircleIcon", height: 512, width: 512, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public PauseCircleIcon() : base(_definition) { }
    }
}