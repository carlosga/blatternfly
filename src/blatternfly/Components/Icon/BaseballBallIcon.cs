...
/// <summary>BaseballBallIcon icon.</summary>
public sealed class BaseballBallIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "BaseballBallIcon", height: 512, width: 496, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
