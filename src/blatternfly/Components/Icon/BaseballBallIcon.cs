namespace Blatternfly.Components
{
    public sealed class BaseballBallIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "BaseballBallIcon", height: 512, width: 496, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public BaseballBallIcon() : base(_definition) { }
    }
}