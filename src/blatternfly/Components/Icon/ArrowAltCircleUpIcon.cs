...
public sealed class ArrowAltCircleUpIcon : BaseIcon
{
    ...
    public static readonly IconDefinition IconDefinition = new(name: "ArrowAltCircleUpIcon", height: 512, width: 512, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
