...
/// <summary>TrendUpIcon icon.</summary>
public sealed class TrendUpIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "TrendUpIcon", height: 1024, width: 960, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
