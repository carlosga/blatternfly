namespace Blatternfly.Components
{
    public sealed class AngleLeftIcon : BaseIcon
    {
        ...
        private static readonly IconDefinition _definition = new IconDefinition(name: "AngleLeftIcon", height: 512, width: 256, svgPath: _svgPath, transform: "", yOffset: "", xOffset: "");

        public AngleLeftIcon() : base(_definition) { }
    }
}