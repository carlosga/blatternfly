...
/// <summary>AngleLeftIcon icon.</summary>
public sealed class AngleLeftIcon : BaseIcon
{
    ...
    internal static readonly IconDefinition IconDefinition = new(name: "AngleLeftIcon", height: 512, width: 256, svgPath: _svgPath, transform: null, offsetY: "", offsetX: "");
