...
public partial class ClipboardCopyButton : ComponentBase
{
    ...
    /// <summary>Callback for the copy when the button is clicked.</summary>
    [Parameter] public EventCallback<MouseEventArgs> OnClick { get; set; }

    /// <summary>ID of the copy button.</summary>
    [Parameter] public string id { get; set; }

    /// <summary>ID of the content that is being copied.</summary>
    ...
    /// <summary>Aria-label for the copy button.</summary>
    [Parameter] public string AriaLabel { get; set; } = "Copyable input";

    /// <summary>Variant of the copy button.</summary>
