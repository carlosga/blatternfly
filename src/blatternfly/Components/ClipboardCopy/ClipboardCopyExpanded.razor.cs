...
public partial class ClipboardCopyExpanded : ComponentBase
{
    ...
    /// <summary>On change callback.</summary>
    [Parameter] public EventCallback<ChangeEventArgs> OnChange { get; set; }

    /// <summary>Gets or sets a value indicating whether the element is readonly.</summary>
    [Parameter] public bool IsReadOnly { get; set; }

    /// <summary>Gets or sets a value indicating whether the element is showing code.</summary>
