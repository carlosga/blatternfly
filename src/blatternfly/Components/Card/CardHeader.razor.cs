...
public partial class CardHeader : ComponentBase
{
    ...
    /// <summary>Callback expandable card.</summary>
    [Parameter] public EventCallback<MouseEventArgs> OnExpand { get; set; }

    /// <summary>Additional props for expandable toggle button.</summary>
    [Parameter] public IReadOnlyDictionary<string, object> ToggleButtonProps { get; set; }

    /// <summary>Whether to right-align expandable toggle button.</summary>
