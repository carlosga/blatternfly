...
public partial class Masthead : ComponentBase
{
    ...
    /// </summary>
    [Parameter]
    public MastheadBackground BackgroundColor { get; set; } = MastheadBackground.Dark;

    /// <summary>
    /// Display type at various breakpoints.
    /// </summary>
    [Parameter]
    public MastheadDisplayModifiers Display { get; set; } = new () { Medium = MastheadDisplay.Inline };

    /// <summary>
    /// Insets at various breakpoints.
    /// </summary>
    [Parameter]
    public InsetModifiers Inset { get; set; }
