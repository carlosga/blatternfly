...
/// <summary> The main alert component.</summary>
public partial class Alert : ComponentBase
{
    ...
    /// <summary>Close button; use the AlertActionCloseButton component.</summary>
    [Parameter] public RenderFragment ActionClose { get; set; }

    /// <summary>Action links; use a single AlertActionLink component or multiple wrapped in an array or React.Fragment.</summary>
    [Parameter] public RenderFragment ActionLinks { get; set; }

    /// <summary>Adds accessible text to the Alert.</summary>
    [Parameter] public string AriaLabel { get; set; }

    /// <summary>Set a custom icon to the Alert. If not set the icon is set according to the variant.</summary>
    [Parameter] public RenderFragment CustomIcon { get; set; }

    /// <summary>Uniquely identifies the alert.</summary>
    [Parameter] public string id { get; set; }

    /// <summary>Flag indicating that the alert is expandable</summary>
    [Parameter] public bool IsExpandable { get; set; }

    /// <summary>Flag to indicate if the Alert is inline.</summary>
    [Parameter] public bool IsInline { get; set; }

    /// <summary>Flag to indicate if the Alert is in a live region.</summary>
    [Parameter] public bool IsLiveRegion { get; set; }

    /// <summary>Flag to indicate if the alert is plain.</summary>
    [Parameter] public bool IsPlain { get; set; }

    /// <summary>Title of the Alert.</summary>
    [Parameter] public string Title { get; set; }

    /// <summary>Sets the heading level to use for the alert title. Default is h4.</summary>
    [Parameter] public HeadingLevel TitleHeadingLevel { get; set; } = HeadingLevel.h4;

    /// <summary>Adds accessible text to the alert Toggle.</summary>
    ...
    /// <summary>Adds alert variant styles.</summary>
    [Parameter] public AlertVariant Variant { get; set; } = AlertVariant.Default;

    /// <summary>Variant label text for screen readers.</summary>
