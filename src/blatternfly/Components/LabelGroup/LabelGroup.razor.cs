...
public partial class LabelGroup<TItem> : ComponentBase
{
    ...
    /// <summary>Flag for having the label group default to expanded.</summary>
    ...
    /// <summary>Customizable template string. Use placeholder "{0}" for the overflow label count.</summary>
    [Parameter] public string CollapsedText { get; set; } = "{0} more";

    /// <summary>Category name text for the label group category.  If this prop is supplied the label group with have a label and category styling applied.</summary>
    [Parameter] public string CategoryName { get; set; }

    /// <summary>Aria label for label group that does not have a category name.</summary>
    [Parameter] public string AriaLabel { get; set; } = "Label group category";

    /// <summary>Set number of labels to show before overflow.</summary>
    [Parameter] public int NumLabels { get; set; } = 3;

    /// <summary>Flag if label group can be closed.</summary>
    [Parameter] public bool IsClosable { get; set; }

    /// <summary>Flag indicating the labels in the group are compact.</summary>
    [Parameter] public bool IsCompact { get; set; }

    /// <summary>Aria label for close button.</summary>
    [Parameter] public string CloseBtnAriaLabel { get; set; } = "Close label group";

    /// <summary>Function that is called when clicking on the label group close button.</summary>
    [Parameter] public EventCallback<MouseEventArgs> OnClick { get; set; }

    /// <summary>Flag to implement a vertical layout.</summary>
    [Parameter] public bool IsVertical { get; set; }

    /// <summary>@beta Control for adding new labels.</summary>
    [Parameter] public RenderFragment AddLabelControl { get; set; }

    /// <summary>Item template</summary>
    [Parameter] public RenderFragment<TItem> ItemTemplate { get; set; }

    /// <summary>Label Group items.</summary>
