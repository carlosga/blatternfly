...
public partial class LabelGroup<TItem> : ComponentBase
{
    ...
    /// </summary>
    [Parameter]
    public string AriaLabel { get; set; } = "Label group category";

    /// <summary>
    /// Set number of labels to show before overflow.
    /// </summary>
    [Parameter]
    public int NumLabels { get; set; } = 3;
    ...
    /// </summary>
    [Parameter]
    public string CloseBtnAriaLabel { get; set; } = "Close label group";
    ...
    /// </summary>
    [Parameter]
    public RenderFragment AddLabelControl { get; set; }
