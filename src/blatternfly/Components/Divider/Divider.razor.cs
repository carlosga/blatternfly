...
public partial class Divider : ComponentBase
{
    ...
    /// <summary>The component type to use.</summary>
    ...
    /// <summary>Indicates how the divider will display at various breakpoints. Vertical divider must be in a flex layout.</summary>
